...
BOT_TOKEN = getenv("BOT_TOKEN", "6009759960:AAEdDeqbXcaRLStKJBCa1150EMWvCQfgZyw")
...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/cute_girl_music_support")
